...
userType nvarchar(30) not null,--用户类型(注册用户 部门审核员 形式审核员 超级管理)
unitName nvarchar(50) not null,--单位全称
primary key(userID),
)
...
userType nvarchar(30) not null,--用户类型(注册用户 管理员 超级管理)
permissions1 nvarchar(30) not null,--权限1()
permissions2 nvarchar(30) not null,--权限1()
permissions3 nvarchar(30) not null,--权限1()
)
...
unitCPeople nvarchar(50) not null,--联系人
...
demandState1 nvarchar(30) not null,--前端状态(保存,提交,)
demandState2 nvarchar(30) not null,--审核状态(未审核,未通过,形式审核通过,部门审核通过)
