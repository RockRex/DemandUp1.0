...
<center>
	<table>
		...
		<%
			...
			String s2 = "select * from Requirement where demandState1='提交' and demandState2='未审核'";
			...
			while(rs2.next())
			{
				out.println(
						...
						"</td><td width='100'>" + "<a href='formal.jsp?RequirementID="+rs2.getString("demandID")+"'>形式审核</a>"+			    
						"</td></tr>");
			}
			rs2.close();
			db.close();
