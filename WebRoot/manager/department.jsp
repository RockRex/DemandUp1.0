...
<br/><br/>
<form name="homeForm" id="homeForm" method="post" action ="departmentcheck.jsp">
...
<INPUT TYPE="hidden"  id = "demandID" name = "demandID" value="<%out.print(rs.getString("demandID"));%>">
            <table>
					...
					<tr>
  						<td>审核部门</td>
  						<td colspan="3"><%out.print(rs.getString("Auditopinion")); %></td>  
  					</tr>
	    			<tr>
  					...
  					<tr>
  						<td colspan="4" style="height:150px;">
   							<textarea name="Auditopinion" id="Auditopinion" style="width:100%;height:100%" required><%out.print(rs.getString("Auditopinion")); %></textarea>
  						</td>  
  					</tr>
  				...
  				<tr>
  					...
  					<INPUT TYPE="hidden"  id = "shenhejieguo" name = "shenhejieguo">
   					<INPUT TYPE="button" value="通过" onclick="pass2()" style="width:100px;height:30px;color:#Black">
   					<INPUT TYPE="button" value="不通过" onclick="nopass2()" style="width:100px;height:30px;color:#Black">
  					</td>  
  					</tr>
