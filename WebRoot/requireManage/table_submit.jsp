...
<center>
	<table>
		...
		<%
			...
			String s2 = "select * from Requirement where unitID='"+unitID+"'and demandState1='提交' and demandState2='未审核';";
			...
			while(rs2.next())
			{
				out.println(
						...
						"</td><td>" + "<a href='../unit/show.jsp?RequirementID="+rs2.getString(1)+"'>查看</a>"+
						"</td><td>" + "<a href='../unit/edit.jsp?RequirementID="+rs2.getString(1)+"'>修改</a>"+		    
						"</td></tr>");
			}
			rs2.close();
			db.close();
