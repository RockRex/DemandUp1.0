...
<center>
	<table>
		<tr>
			...
			<td align="center" width="150"colspan="4">操作</td>			
		</tr>
		...
		<%
			...
			String s2 = "select * from Requirement where unitID='"+unitID+"'and demandState1='保存';";
			...
			while(rs2.next())
			{
				out.println(
						...
						"</td><td>" + "<a href='../unit/show.jsp?RequirementID="+rs2.getString("demandID")+"'>查看</a>"+
						"</td><td>" + "<a href='../unit/edit.jsp?RequirementID="+rs2.getString("demandID")+"'>修改</a>"+
						"</td><td>" + "<a href='../unit/submitCheck.jsp?RequirementID="+rs2.getString("demandID")+"'>提交</a>"+	
