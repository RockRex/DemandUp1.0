...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<%
		...
		if(LoginID==null){
			out.print("<script language='javaScript'> alert('请您先登录，谢谢！');</script>");
			response.setHeader("Refresh","1;URL=Login.jsp"); //注意该方法的写法
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="yes" width="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/accordition_3.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" width="100%"height="100%" frameBorder=0 id=frmright name=frmright src="welcome.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
