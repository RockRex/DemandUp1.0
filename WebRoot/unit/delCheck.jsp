...
<body>
	...
	<%
	    ...
	    String s="select * from Requirement where demandID="+"'"+RequirementID+"'";
		String unitID="";
		ResultSet rs1=db.executeQuery(s);
		while(rs1.next())
		{
			unitID=rs1.getString("unitID");
		}
		
		String s1="update Requirement set demandState1='删除',"+
		"unitID='"+unitID+
		"X' where demandID='"+RequirementID+"'";
