...
<br/><br/><p />
 <jsp:useBean id="db" class="bean.DBean" scope="page" />
	    ...
	    %>
            <table>
                   <tr>
					...
					<tr>
						<td>审核结果</td>
						<td colspan="4"><%out.print(rs.getString("demandState2")); %></td>
					</tr>
					<tr>
						<td colspan="5">审核意见</td>
					</tr>
					<tr>
					     <td colspan="5"style="height:150px;"><%out.print(rs.getString("Auditopinion")); %></td>	
					</tr>
					</table> 
					<%
	        }
		...
		<br/>
		<table>
		<form action="../requireManage/table_all.jsp">
